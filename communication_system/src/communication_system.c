...
/* Description of the lights gpio interface used by the `CommunicationSystem` entity. */
...
int main(int argc, const char *argv[])
{
    ...
    fprintf(stderr, "Hello I'm CommunicationSystem\n");

    /**
     * Get the ControlSystem IPC handle of the connection named
     ...
     */
    nk_iid_t riid = ServiceLocatorGetRiid(handle, "controls.mode");
    ...
    for (i = 0; i < MODES_NUM; i++)
    {
        ...
        
        {
             ...
             */
            fprintf(stderr, "result(CommunicationSystem) = %0x\n", (int) res.result);
            /**
            ...
            fprintf(stderr, "Failed to call traffic_light.ControlSystem.Mode()\n");
    }
